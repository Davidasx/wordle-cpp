...
void rating(){
	clear_screen();
	scta(text);
	putstring("Wordle > Help > Rating");changeline();
	...
	clr(0);putstring("0000");scta(text);putstring(" to ");
	clr(799);putstring("0799");scta(text);putstring(" : ");
	clr(799);putstring("newbie");changeline();scta(text);
	clr(800);putstring("0800");scta(text);putstring(" to ");
	clr(999);putstring("0999");scta(text);putstring(" : ");
	clr(999);putstring("pupil");changeline();scta(text);
	...
	clr(1999);putstring("1999");scta(text);putstring(" : ");
	clr(1999);putstring("grandmaster");changeline();scta(text);
	clr(2000);putstring("2000");scta(text);putstring(" to ");
	clr(2400);putstring("2400");scta(text);putstring(" : ");
	clr(2400);putstring("legendary");changeline();scta(text);
	pause();
}
void help(){
	while(1){
